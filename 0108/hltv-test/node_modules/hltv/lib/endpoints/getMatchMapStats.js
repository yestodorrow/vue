...
var getMatchMapStats = function (config) { return function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var getMatchInfoRowValues, getPlayerTopStat, _a, m$, p$, matchPageID, map, date, team1, team2, event, teamStatProperties, teamStats, mostXProperties, mostX, overview, fullRoundHistory, _b, rh1, rh2, roundHistory, playerPerformanceStats, playerOverviewStats, playerStats, performanceOverview;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4, Promise.all([
                            mappers_1.fetchPage(config.hltvUrl + "/stats/matches/mapstatsid/" + id + "/-"),
                            mappers_1.fetchPage(config.hltvUrl + "/stats/matches/performance/mapstatsid/" + id + "/-")
                        ])];
                case 1:
                    _a = _c.sent(), m$ = _a[0], p$ = _a[1];
                    ...
                    _b = [fullRoundHistory.slice(0, 30), fullRoundHistory.slice(30, 60)], rh1 = _b[0], rh2 = _b[1];
