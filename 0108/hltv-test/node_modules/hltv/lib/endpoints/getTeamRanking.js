...
var getTeamRanking = function (config) { return function (_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.year, year = _c === void 0 ? '' : _c, _d = _b.month, month = _d === void 0 ? '' : _d, _e = _b.day, day = _e === void 0 ? '' : _e;
    return __awaiter(_this, void 0, void 0, function () {
        var $, teams;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, mappers_1.fetchPage(config.hltvUrl + "/ranking/teams/" + year + "/" + month + "/" + day)];
                case 1:
                    $ = _a.sent();
                    teams = mappers_1.toArray($('.ranked-team')).map(function (teamEl) {
                        ...
                        var change = changeText === '-' ? 0 : Number(changeText);
...
exports.default = getTeamRanking;
