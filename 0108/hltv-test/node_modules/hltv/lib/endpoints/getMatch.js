...
var getMatch = function (config) { return function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var $, title, date, format, additionalInfo, live, hasScorebot, teamEls, team1, team2, winnerTeam, vetoes, event, maps, players, streams, highlightedPlayerLink, highlightedPlayer, headToHead, highlights;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, mappers_1.fetchPage(config.hltvUrl + "/matches/" + id + "/-")];
                case 1:
                    $ = _a.sent();
                    ...
                    if (team1 && team2) {
                        vetoes = mappers_1.toArray($('.veto-box').last().find('.padding > div')).slice(0, -1).map(function (el) { return mappers_1.mapVetoElementToModel(el, team1, team2); });
                    }
                    event = {
                    ...
                    return [2, {
                            team1: team1, team2: team2, winnerTeam: winnerTeam, date: date, format: format, additionalInfo: additionalInfo, event: event, maps: maps, players: players, streams: streams, live: live,
                            title: title, hasScorebot: hasScorebot, highlightedPlayer: highlightedPlayer, headToHead: headToHead, vetoes: vetoes, highlights: highlights
                        }];
            }
        });
    });
