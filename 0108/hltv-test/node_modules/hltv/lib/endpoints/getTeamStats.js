...
var getTeamStats = function (config) { return function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4, mappers_1.fetchPage(config.hltvUrl + "/stats/teams/" + id + "/-")];
                case 1:
                    $ = _b.sent();
                    return [4, mappers_1.fetchPage(config.hltvUrl + "/stats/teams/matches/" + id + "/-")];
                case 2:
                    m$ = _b.sent();
                    return [4, mappers_1.fetchPage(config.hltvUrl + "/stats/teams/events/" + id + "/-")];
                case 3:
                    e$ = _b.sent();
                    return [4, mappers_1.fetchPage(config.hltvUrl + "/stats/teams/maps/" + id + "/-")];
                case 4:
                    mp$ = _b.sent();
