        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, mappers_1.fetchPage(config.hltvUrl + "/results?offset=" + i * 100)];
                case 2:
                    $ = _a.sent();
                    matches = matches.concat(mappers_1.toArray($('.result-con .a-reset')).map(function (matchEl) {
                        ...
                        return { id: id, team1: team1, team2: team2, result: result, event: event, map: map, format: format, stars: stars };
                    }));
                    _a.label = 3;
                case 3:
                    i++;
